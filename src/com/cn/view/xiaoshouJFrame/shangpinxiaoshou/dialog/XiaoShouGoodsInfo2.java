...
import com.cn.control.xiaoshouframe.shangpinxiaoshuo.GoodsInfo2_SureAction;
import com.cn.control.xiaoshouframe.shangpinxiaoshuo.XiaoShouGoodsInfo2_DocumentListener;
import com.cn.control.xiaoshouframe.shangpinxiaoshuo.XiaoShuoGoods2InfoAction;
 ...
 *
 */
public class XiaoShouGoodsInfo2 extends JDialog {
//	父窗口
    ...
    //打折率
	  ...
	  public XiaoShouGoodsInfo2(AddXiaoShouGoodsDialog dialog,String title){
		  super(dialog,title,true);
		  this.dialog = dialog;
		  this.addWindowListener(new XiaoShuoGoods2InfoAction(this));
		  init();
	  }
	  public void init(){
		...
		public JPanel createCenterPanel(){
			...
			canKaoShouJia.getDocument().addDocumentListener(new XiaoShouGoodsInfo2_DocumentListener(this));
			box1.add(new JLabel("元"));
			box1.add(Box.createHorizontalStrut(8));
			box1.add(new JLabel("打折率:"));
			box1.add(daZhe);
			daZhe.getDocument().addDocumentListener(new XiaoShouGoodsInfo2_DocumentListener(this));
			box1.add(Box.createHorizontalStrut(8));
			box1.add(new JLabel("数量:"));
			box1.add(shuLiang);
			shuLiang.getDocument().addDocumentListener(new XiaoShouGoodsInfo2_DocumentListener(this));
		...
		public JPanel initSouthPanel() {
			...
			southPanel.add(sure);
			sure.addActionListener(new GoodsInfo2_SureAction(this));

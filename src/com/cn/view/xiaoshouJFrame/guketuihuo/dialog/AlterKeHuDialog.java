 ...
 *
 */
public class AlterKeHuDialog extends JDialog {
	...
	public AlterKeHuDialog(KeHuWindow window,String title){
		super(window,title);
		this.window = window;
		init();
	}
	...
	public JPanel createPanel(){
       ...
       JLabel lxdzLabel =  new JLabel("联系地址:");
        ...
        layout.setConstraints(mrkh, new GBC(1, 8).setInsets(10, 10, 4, 4));
        panel.add(mrkh);

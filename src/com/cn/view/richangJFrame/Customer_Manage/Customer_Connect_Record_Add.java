...
import com.cn.dao.richang.Customer_Manage.Action_Connect_Record_Add;
import com.cn.dao.richang.Customer_Manage.JDBC_Connect_Record;
import com.cn.util.JDatePicker;

public class Customer_Connect_Record_Add extends JDialog{
	...
	public Customer_Connect_Record_Add(Customer_Manage cm ,String title, boolean b) {
		super(cm,title,b);
		this.cm = cm;
	...
	private void init() {
		...
		save.addActionListener(new Action_Connect_Record_Add(Customer_Connect_Record_Add.this));

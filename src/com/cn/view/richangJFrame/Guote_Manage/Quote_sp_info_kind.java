...
import com.cn.control.richangframe.Guote_Manage.Action_sp_info_kind_Confirm;


public class Quote_sp_info_kind extends JDialog{
	...
	public Quote_sp_info_kind(Add_Quote_Goods aqgs,String title,boolean b){
		super(aqgs,title,b);
		this.aqgs = aqgs;
		init();
	...
	private void init() {
		...
		Vector v = (Vector)aqgs.getData_left_tab_2().get(aqgs.getTable_tab_2().getSelectedRow());
		...
		comfirm.addActionListener(new Action_sp_info_kind_Confirm(Quote_sp_info_kind.this));

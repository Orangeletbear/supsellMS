...
public class JinHuoZhongDialog extends JDialog implements ActionListener {
     JTabbedPane mainPane;//添加选项卡的容器
     JinHuoDialog dialog;
     /*
      * 按条件查询选项卡的组件
      */
     JComboBox shangPinKind = new JComboBox(JDBCCuCunFind.getSpLbData());
     JTextField xiaoShouLiang1,xiaoShouLiang2;
     JComboBox date;
	 ...
	 * @param modal
	 */
      public JinHuoZhongDialog(JinHuoDialog dialog,String title,boolean modal){
    	  super(dialog,title,modal);
    	  this.dialog=dialog;
    	  init();
      }
      public JinHuoDialog getDialog() {
		return dialog;
	}
	private void init(){
    ...
    private JTabbedPane addPane(){
    	...
    	tianJia=new JButton("添加到参考进货");
    	date=new JComboBox(dateBoxNames);
    	shangPinKind.addItem("所有类别");
    	shangPinKind.setSelectedItem("所有类别");
	...
	public void actionPerformed(ActionEvent e) {
        	  ...
        	  try {
				Vector vector=JinHuoJDBC.getTiaoJianJDBC(DateConventer.dateToStr(datePickerTo.getSelectedDate()), 
						  DateConventer.dateToStr(datePickerTo2.getSelectedDate()), 
								  shangPinKind.getSelectedItem().toString(),xiaoShouLiang1.getText(),xiaoShouLiang2.getText());
          ...
          if(e.getSource()==tianJia){
        	  new CanShuDialog(this,"输入参考进货数量",true);
          }
	...
	public JComboBox getShangPinKind() {
		return shangPinKind;
	}
	public JTextField getXiaoShouLiang1() {
		return xiaoShouLiang1;
	}
	public JTextField getXiaoShouLiang2() {
		return xiaoShouLiang2;
	}
	...
	public JButton getTianJia1() {
		return tianJia1;
	}
	public JTextField getShangPinNames() {
		return shangPinNames;
	}
	public JRadioButton getXuanZe() {
		return xuanZe;
	}
	public JButton getChaXun2() {
		return chaXun2;
	}
	public JButton getTianJia2() {
		return tianJia2;
	}
	public JTextField getGongHuoShangNames() {
		return gongHuoShangNames;
	}

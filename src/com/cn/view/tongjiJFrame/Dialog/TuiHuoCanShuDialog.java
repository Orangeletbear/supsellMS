...
public class TuiHuoCanShuDialog extends JDialog implements ActionListener{
	TuiHuoZhongDialog dialog;
   ...
   public TuiHuoCanShuDialog(TuiHuoZhongDialog dialog,String tilte,boolean b){
   ...
   private void init(){
	   ...
	   southP.add(new JLabel("参考退货数量:"),new GBC(0,0).setInsets(4, 4, 4, 4));

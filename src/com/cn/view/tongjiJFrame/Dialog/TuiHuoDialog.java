...
public class TuiHuoDialog extends JDialog implements ActionListener {
     ...
     JLabel jiLu;
     String tableNames[]={"商品编号","商品名称","单位","规格型号","颜色","供应商","参考退货数量","当前库存数量"};
     String column[][];
      ...
      */
      public TuiHuoDialog(JDialog frame,String title,boolean modal){
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==addChaXun){
			new TuiHuoZhongDialog(this,"添加参考进货商品",true);
		}
		...
		if(e.getSource()==changeCount){
			new TuiHuoXiuGaiDialog(this,"修改数量",true);
		}

...
public class DanJuKeHuJDialog extends JDialog implements ActionListener {
    ...
    JTable GHSTable;
	 ...
	 String GhsColumn[][];
    public  DanJuKeHuJDialog(WangLaiZhangWu frame,String title,boolean b){
		super(frame,title,b);
		this.frame=frame;
		init();
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==queDing){
			...
			frame.getGongHuoShangMingCheng().setText(GHS.getValueAt(GHSTable.getSelectedRow(), 1).toString());
		    this.dispose();
		}
	}
}

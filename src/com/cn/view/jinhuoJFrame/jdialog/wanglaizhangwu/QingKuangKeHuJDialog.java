...
public class QingKuangKeHuJDialog extends JDialog implements ActionListener {
    ...
    JTable GHSTable;
	 ...
	 String GhsColumn[][];
    public  QingKuangKeHuJDialog(WangLaiZhangWu frame,String title,boolean b){
		super(frame,title,b);
		this.frame=frame;
		init();
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==queDing){
			...
			frame.getPanel2_center_gongHuoShangMingCheng().setText(GHS.getValueAt(GHSTable.getSelectedRow(), 1).toString());
		    this.dispose();
		}
	}
}

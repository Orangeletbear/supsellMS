...
public class GongHuoShangJDialog extends JDialog {
	/*
	 * 父窗口
	 */
	private CaiGouTuiHuo fuChuangKou;
	//center组件
	...
	public GongHuoShangJDialog(JDialog dialog,String title,boolean model){
		super(dialog,title,model);
		this.fuChuangKou = (CaiGouTuiHuo)dialog;
	  ...
	  table.addMouseListener(new MouseAdapter(){
		...
		public void mouseClicked(MouseEvent e) {
			...
			if(e.getClickCount() == 2){
				fuChuangKou.getGongHuoShang().setText(gonghuoshang);
				GongHuoShangJDialog.this.dispose();
			}
		}
...
//south
  private JPanel south_Pane(){
	  ...
	  //修改
	  JButton xiugai = new JButton("修改供货商(f9)");
	  xiugai.addActionListener(new ActionListener(){
		  public void actionPerformed(ActionEvent e) {
			new GongHuoShang(GongHuoShangJDialog.this,/////////////////
					"修改供货商" );
		  }
	  });
  ...
  public static void main(String[] args){
	  new GongHuoShangJDialog((JDialog)null,"供货商",true);
  }

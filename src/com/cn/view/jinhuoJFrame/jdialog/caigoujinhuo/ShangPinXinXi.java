...
import com.cn.control.jinhuoframe.caigoujinhuo.ShangPinXinXiListener;
import com.cn.control.jinhuoframe.caigoujinhuo.ShangPingXinXiBtnListener;
 ...
 *
 */
public class ShangPinXinXi extends JDialog{
	/*
	 * 父窗口
	 */
	 ...
	 */
	public ShangPinXinXi(JDialog dialog,String title,boolean model){
		...
		this.addWindowListener(new ShangPinXinXiListener(this,argspid));//初始化界面数据
	...
	JPanel panel_south = new JPanel();
		...
		tuichu.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				ShangPinXinXi.this.dispose();
			}
		});
		pane2.setLayout(new FlowLayout(FlowLayout.CENTER,60,1));
		//确认按钮上的大文章监听器
		queren.addActionListener(new ShangPingXinXiBtnListener(this,dialog));
		pane2.add(queren);
		pane2.add(tuichu);

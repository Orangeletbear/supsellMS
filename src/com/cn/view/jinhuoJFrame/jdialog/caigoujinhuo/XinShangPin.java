...
import com.cn.view.systemJFrame.shangpingxinxidialog.GetFinallyMassage;
 ...
 *
 */
public class XinShangPin extends JDialog {
	//商品类别
	...
	public XinShangPin(CaiGouJinHuo argDialog,String title,boolean model){
		super(argDialog,title,model);
		init();

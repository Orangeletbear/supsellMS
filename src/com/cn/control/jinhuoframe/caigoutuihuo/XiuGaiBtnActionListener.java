...
import com.cn.view.jinhuoJFrame.jdialog.caigoutuihuo.ShangPinXinXi2JDialog;
import com.cn.view.jinhuoJFrame.jdialog.caigoutuihuo.TuiHuoShangPin;

public class XiuGaiBtnActionListener implements ActionListener{

	TuiHuoShangPin addShang;//父窗口
	ShangPinXinXi2JDialog shang;//当前窗口
	
	public XiuGaiBtnActionListener(ShangPinXinXi2JDialog dialog){
		this.shang = dialog;

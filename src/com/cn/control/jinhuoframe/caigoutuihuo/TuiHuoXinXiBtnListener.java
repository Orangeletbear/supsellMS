...
import com.cn.view.jinhuoJFrame.jdialog.caigoutuihuo.TuiHuoXinXiJDialog;

public class TuiHuoXinXiBtnListener implements ActionListener{

	//父窗口
	private TuiHuoShangPin dialog;
	//当前窗口
	private TuiHuoXinXiJDialog shangDialog;
	
	
	public TuiHuoXinXiBtnListener(TuiHuoXinXiJDialog shangDialog,TuiHuoShangPin dialog){
		this.dialog = dialog;
